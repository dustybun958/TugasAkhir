                        ...
                        <table class="table table-hover table-bordered" id="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$artikel->kategori->deskripsi}}</td>
                                    <td>{{$artikel->judul}}</td>
                                    <td>{!!$artikel->deskripsi!!}</td>
                                    <td>
                                        <a href="{{route('editArtikel',['id'=>$artikel->id])}}" class="btn btn-warning btn-sm" role="button">Edit</a>
                                        <a onclick="confirmDelete(this)" data-url="{{route('deleteArtikel',['id'=>$artikel->id])}}" class="btn btn-danger btn-sm" role="button">Hapus</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
